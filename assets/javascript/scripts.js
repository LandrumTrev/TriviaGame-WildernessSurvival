...
$(document).ready(function () {
    ...
    function backgrounder() {
        ...
        $('body').attr('style', 'background:linear-gradient(217deg, rgba(183, 197, 208, .8), rgba(183, 197, 208, 0) 70.71%),linear-gradient(127deg, rgba(220, 235, 193, .8), rgba(220, 235, 193, 0) 70.71%),linear-gradient(336deg, rgba(208, 198, 183, .8), rgba(208, 198, 183, 0) 70.71%),url(assets/images/' + randomback + '.jpg) no-repeat center center fixed;background-size: cover;');
